package com.vinsguru.reactive_kafka_playgroud.sec04;
...
public class KafkaProducer {
    ...
    private static SenderRecord<String, String, String> createSenderRecord(Integer i) {
        ...
        headers.add("clientId", "some-client".getBytes(StandardCharsets.UTF_8));
        headers.add("tracingId", "123".getBytes(StandardCharsets.UTF_8));
